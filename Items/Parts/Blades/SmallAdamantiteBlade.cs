...
{
    public class SmallAdamantiteBlade : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Small Adamantite Blade");
            Tooltip.SetDefault("A small blade casted from molten adamantite");
        }
        public override void SetDefaults()
        {
            item.width = 24; // Hitbox Width
            item.height = 24; // Hitbox Height 
            item.value = 20000; // 10 | 00 | 00 | 00 : Platinum | Gold | Adamantite | Bronze
