...
namespace HeavenlyAscension.Items.Blueprints.ToolBlueprints.GuardBlueprints
{
    public class SmallGuardBlueprint  : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Small Guard Blueprint");
            Tooltip.SetDefault("A small blueprint with a guard design chalked on it");
        }
