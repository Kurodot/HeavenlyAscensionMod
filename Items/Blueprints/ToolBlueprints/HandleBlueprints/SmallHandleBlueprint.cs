...
{
    public class SmallHandleBlueprint  : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Small Handle Blueprint");
            Tooltip.SetDefault("A small blueprint with a handle design chalked on it");
        }
